...
| [`docs/DESIGN.md`](docs/DESIGN.md) | The colour system, the hero, the chart, and the layout defects fixed in 1.1 |
| [`docs/DESIGN_REVIEW.md`](docs/DESIGN_REVIEW.md) | The review of the 1.0 screenshots that this work came from |
