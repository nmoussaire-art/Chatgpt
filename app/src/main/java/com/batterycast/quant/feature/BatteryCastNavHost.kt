...
fun BatteryCastNavHost(navController: NavHostController = rememberNavController()) {
    // Every label is one short word. "Chances" wrapped onto two lines at a large display size,
    // which pushed that one item taller than the rest and broke the alignment of the whole bar on
    // every screen; single-line rendering below makes the wrap structurally impossible.
    val destinations = listOf(
        ...
        BottomDestination(Routes.PROBABILITY, "Insights", Icons.Outlined.Insights),
        BottomDestination(Routes.PLANNER, "Planner", Icons.Outlined.Bolt),
                ...
                destinations.forEach { destination ->
                    ...
                    NavigationBarItem(
                        ...
                        colors = NavigationBarItemDefaults.colors(
                            ...
                            selectedTextColor = semantic.positive,
                            indicatorColor = semantic.positive,
